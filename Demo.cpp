...
void Demo::Render() {
	...
	glm::mat4 view = glm::lookAt(glm::vec3(5,10, 30), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0));
...
void Demo::DrawColoredCube4()// kaki 3
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-6, 0, -5));
...
void Demo::DrawColoredCube5() //kaki 4
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(10, 0, -5));
...
void Demo::DrawColoredCube6() //Papan
{
	...
	model = glm::scale(model, glm::vec3(17, 0.5, 8));
